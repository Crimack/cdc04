...
\vskip .13in
\hbox{{\bf  Classes}}
\entityintro{StateAnalyser}{cdc04.StateAnalyser}{}
\vskip .1in
\vskip .1in
...
{\bf  buildClassifier}\\
\begin{lstlisting}[frame=none]
public void buildClassifier(weka.core.Instances data) throws java.lang.Exception\end{lstlisting} %end signature
\begin{itemize}
\item{
{\bf  Description}
