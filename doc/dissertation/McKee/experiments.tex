...
The results gained from the above experiments are inconclusive, While the J48 classifier became less accurate when trained iteratively and appeared to make larger errors according to the RMSE test, the MAE result is an interesting case and could be explored further.
